  ...
  return (
    <section className="bg-white py-16 px-4 text-center">
      <div className="container mx-auto">
        ...
        <button className="inline-flex items-center space-x-2 px-8 py-4 bg-gray-900 text-white font-bold rounded-lg shadow-lg transition duration-300 hover:bg-gray-500">
